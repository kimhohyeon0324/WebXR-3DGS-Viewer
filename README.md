...
* **실측 관찰 및 분석**:
  ...
  3. **하드웨어 텔레메트리 한계**: 웹 브라우저 보안 샌드박스 정책으로 인해 기기 내부의 순수 GPU 점유율(%), VRAM 사용량(MB), 칩셋 온도는 웹 페이지 내에서 접근이 차단됨 ([9. 한계점 및 향후 과제](#9-한계점-및-향후-과제) 참고).
